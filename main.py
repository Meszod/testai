...
ADMIN_USERNAME = "sltnvv_de"
BOT_USERNAME = "teeeestaibot"
DB_FILE = "quiz_pro.db"
...
# ═══════════════════════════════════════════════════════════════
# 📢  ADMIN NOTIFICATION — YANGI FUNKSIYA!
# ═══════════════════════════════════════════════════════════════
async def notify_admins(uid: int, test_title: str, score: int, total: int):
    """
    Test tugaganda barcha adminlarga xabar yuboradi.
    """
...
# ═══════════════════════════════════════════════════════════════
# 🎯  JAVOB HANDLER — ADMIN NOTIFICATION QO'SHILDI!
# ═══════════════════════════════════════════════════════════════
